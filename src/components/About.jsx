...
export default function About() {
  return (
    <section id="sobre" className="py-24 md:py-32 border-t border-line-soft">
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-[0.4fr_0.6fr] gap-10 md:gap-16">
          <p className="font-display text-2xl md:text-3xl text-ink-dim leading-snug italic">
            &ldquo;Rigor analítico, responsabilidade e decisão apoiada em dados.&rdquo;
          </p>

          <div className="space-y-5 text-ink-dim leading-relaxed text-[1.05rem]">
            <p>
              Licenciado em <span className="text-ink">Informática de Gestão Financeira</span> pelo Instituto
              Superior de Administração e Finanças (ISAF), com perfil na intersecção entre finanças e
            ...
            <p>
              Desenvolvi e implementei o <span className="text-gold-bright">RISKFLOW</span>, plataforma de
              gestão e monitorização de risco defendida como trabalho de fim de curso com a classificação de{' '}
              <span className="text-ink">18 valores</span>.
            </p>
            <p>
