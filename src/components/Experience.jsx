...
export default function Experience() {
  return (
    <section id="experiencia" className="py-24 md:py-32 border-t border-line-soft">
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-[220px_1fr] gap-8 md:gap-16">
          <div className="flex md:flex-col gap-4 md:gap-1 items-baseline md:items-start">
            <span className="num text-gold-bright text-lg">2025&ndash;2026</span>
            <span className="text-ink-faint text-sm">Luanda, Angola</span>
          </div>

          <div>
            <h3 className="font-display text-2xl text-ink">Navegador BAI</h3>
